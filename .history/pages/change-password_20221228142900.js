...
function ChangePassword() {
  ...
  const resetPassword = async (e) => {
    ...
    try {
      const { data } = await http().post("profile/change-password", {
        password,
        newPassword,
        confirmPassword,
      });
          ...
          <div className="border-1 bg-white p-[30px] rounded-[25px] pb-[63px]">
            ...
            <form onSubmit={resetPassword} className="md:px-[140px]">
              ...
              <div className="mb-[63px]">
                <label className="flex text-[#A9A9A9CC] text-[16px] leading-[24px] mb-[11px]">
                  <Image src={lockInput} alt="lock-input" className="mr-[20px]" />
                  <input name="newPassword" type="newPassword" placeholder="New password" className="focus:outline-none w-full " />
                  <Image src={eye} alt="eye" className="mr-[20px]" />
                </label>
                <hr />
              </div>
              <div className="mb-[70px]">
                <label className="flex text-[#A9A9A9CC] text-[16px] leading-[24px] mb-[11px]">
                  <Image src={lockInput} alt="lock-input" className="mr-[20px]" />
                  <input name="confirmPassword" type="confirmPassword" placeholder="Repeat new password" className="focus:outline-none w-full " />
                  <Image src={eye} alt="eye" className="mr-[20px]" />
                </label>
                <hr />
              </div>
