      ...
      <div className="bg-[#f5f1f3] pt-[40px] md:flex">
        ...
        <div className="w-full pb-5 pl-5 pr-3 md:pb-0 md:mb-[35px] md:pr-[150px] md:pr-0">
          <div className="border-1 bg-white p-[30px] rounded-[25px]">
            ...
            <div className="">
              <form>
                <input name="amount" placeholder="0.00" className="text-[#B5BDCC] text-[42px] font-bold focus:outline-none text-center" />
                <p className="text-[#3A3D42] text-[16px]">Rp120.000 Available</p>
              </form>
            </div>
          </div>
        </div>
